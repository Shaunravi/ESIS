      ...
      <div class="login">
         ...
         <form method="post" action="register_process.php" class="login__form">
            ...
            <div class="login__inputs">
               ...
               <div class="login__box">
                  <input type="password" placeholder="Password" required class="login__input"  name="password" required name="password" required pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{8,}$" title="Password must contain at least one digit, one lowercase letter, one uppercase letter, one special character, and be at least 8 characters long">
                  <i class="ri-mail-fill"></i>
               </div>
               <div class="login__box">
